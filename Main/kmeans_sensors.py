...
def kmeans_ts(data_scaled,k,slide_len,m,color_list):
    ...
    fig.suptitle('The silhouette coefficient values for kmeans with k = {}'.format(k))
...
thresh_df,std_df,centroids,SSE,CHS,SC  = kmeans_ts(data_scaled,k,slide_len,m, color_list)
