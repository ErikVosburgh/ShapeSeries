# -*- coding: utf-8 -*-
"""
Created on Sun Nov 27 21:20:19 2022
...
def kmeans_DBA_ts(data_scaled,k,slide_len,m,color_list):
    ...
    centroids=np.reshape(centroids,(8,288))
    ...
    fig.suptitle('The silhouette coefficient values for kmeans_DBA with k = {}'.format(k))
    plt.savefig('kmeans_DBA.png',dpi=300, bbox_inches = "tight")
    plt.show()
    ...
    plt.savefig('Kmeans_DBA_ts.png',dpi=300, bbox_inches = "tight") 
...
# thresh_df,std_df,centroids,SSE,CHS,SC  = kmeans_DBA_ts(data_scaled,k,slide_len,m, color_list)
